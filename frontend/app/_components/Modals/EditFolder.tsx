...
export default function Modal({folder}: {folder: ObjectType}) {
    ...
    const handleSumbit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        if(valid) {
            ...
            const response = await getUpdateDeleteFolders(folder.folder_id, "PUT", postData);
    ...
    return (
    <>
        <FcEditImage onClick={e => setOpen(!open)} className="me-4 inline" />
