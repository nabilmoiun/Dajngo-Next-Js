...
export default function Modal() {
    ...
    return (
    <>
        <FcEditImage onClick={e => setOpen(!open)} className="me-4" />
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-4 md:p-5">
                    <form className="space-y-4" action="#">
                        ...
                        <button type="submit" className="w-full text-white bg-primary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-primary dark:focus:bg-primary">Login to your account</button>
                    </form>
                </div>
            </div>
        </div>
